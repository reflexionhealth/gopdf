...
func (t *TTFParser) Parse(fontpath string) error {
	...
	defer fd.Close()
	return t.ParseReader(fd)
}

//ParseReader parse from a reader
func (t *TTFParser) ParseReader(fd io.ReadSeeker) error {
	...
	//fmt.Printf("%#v\n", me.widths)
	fd.Seek(0, 0)
	t.cacheFontData, err = ioutil.ReadAll(fd)
	if err != nil {
		return err
	}
...
func (t *TTFParser) ParseLoca(fd io.ReadSeeker) error {
...
func (t *TTFParser) ParsePost(fd io.ReadSeeker) error {
...
func (t *TTFParser) ParseOS2(fd io.ReadSeeker) error {
	err := t.Seek(fd, "OS/2")
	if err != nil {
		return err
	}
...
func (t *TTFParser) ParseName(fd io.ReadSeeker) error {
...
func (t *TTFParser) ParseCmap(fd io.ReadSeeker) error {
	t.Seek(fd, "cmap")
	t.Skip(fd, 2) // version
	numTables, err := t.ReadUShort(fd)
	if err != nil {
...
func (t *TTFParser) FTell(fd io.ReadSeeker) (uint, error) {
...
func (t *TTFParser) ParseHmtx(fd io.ReadSeeker) error {
...
func (t *TTFParser) ParseHead(fd io.ReadSeeker) error {
...
func (t *TTFParser) ParseHhea(fd io.ReadSeeker) error {
...
func (t *TTFParser) ParseMaxp(fd io.ReadSeeker) error {
	err := t.Seek(fd, "maxp")
	if err != nil {
		return err
	}
...
//Seek seek by tag
func (t *TTFParser) Seek(fd io.ReadSeeker, tag string) error {
...
func (t *TTFParser) ReadUShort(fd io.ReadSeeker) (uint, error) {
...
func (t *TTFParser) ReadShort(fd io.ReadSeeker) (int, error) {
...
func (t *TTFParser) ReadShortInt16(fd io.ReadSeeker) (int16, error) {
...
func (t *TTFParser) ReadULong(fd io.ReadSeeker) (uint, error) {
...
//Skip skip
func (t *TTFParser) Skip(fd io.ReadSeeker, length int) error {
...
//Read read
func (t *TTFParser) Read(fd io.ReadSeeker, length int) ([]byte, error) {
